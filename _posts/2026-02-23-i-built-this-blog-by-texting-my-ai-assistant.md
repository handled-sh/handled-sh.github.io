...
I just *told Handled what I wanted*, and it did the rest.
...
It worked. But it looked... basic.

## "Make it much nicer"

That was my actual message. Three words and a period:
...
Handled uploaded the image to the repository, created a featured blog post around it, updated the homepage layout to show it as a hero banner with a gradient overlay, and optimized the image size for fast loading.

One message. One image. Done.

## The tweaks

Of course, nothing is perfect on the first pass. The image was too large, so I said:

> "It's too large, resize it so it fits neatly."

Fixed. The article pages felt cramped, so I sent a screenshot:
...
Rebuilt with a centered hero header, a purple glow effect, clean section dividers, and a complete rewrite of the copy.

## What this proves

I'm the founder of Handled. I built the product. And yet the thing that still surprises me is this: **I built an entire professional blog in under two hours, on a Saturday night, entirely through WhatsApp messages.**
...
👉 [Get started at handled.sh](https://handled.sh)
